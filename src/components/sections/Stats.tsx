...
const stats: Stat[] = [
  ...
  { value: 100000, suffix: '+', label: 'Companies', sub: 'on the Cayman register', format: (n) => Math.round(n / 1000) * 1000 + '' },
      ...
      <div className="ink-section">
        <Container wide className="relative py-24 sm:py-32">
          <div data-reveal className="flex items-baseline gap-4 mb-16">
            <span className="chapter-num text-base text-gold-light">IV.</span>
